...
# [GCC 5.4.0 20160609]
# Embedded file name: crackme3.py
# Compiled at: 2016-08-02 09:13:26
import textwrap
import sys
print ' _____                           _____             _    '
print '|  __ \\                         |  __ \\           | |   '
print '| |__) |_      ___ __   ___ _ __| |__) |__ _ _ __ | | __'
print "|  ___/\\ \\ /\\ / / '_ \\ / _ \\ '__|  _  // _` | '_ \\| |/ /"
print '| |     \\ V  V /| | | |  __/ |  | | \\ \\ (_| | | | |   < '
print '|_|      \\_/\\_/ |_| |_|\\___|_|  |_|  \\_\\__,_|_| |_|_|\\_\\'
if len(sys.argv) < 2:
